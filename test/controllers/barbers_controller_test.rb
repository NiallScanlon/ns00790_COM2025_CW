...
class BarbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create barber" do
    assert_difference('Barber.count') do
      post barbers_url, params: { barber: { email: @barber.email, name: @barber.name, phone: @barber.phone } }
    end
  ...
  test "should update barber" do
    patch barber_url(@barber), params: { barber: { email: @barber.email, name: @barber.name, phone: @barber.phone } }
